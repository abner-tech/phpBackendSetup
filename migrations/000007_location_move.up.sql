CREATE TABLE IF NOT EXISTS location_move (
    ...
    new_location_name VARCHAR(255) NOT NULL REFERENCES location(farm_name) ON DELETE CASCADE,
    old_location_name VARCHAR(255) REFERENCES location(farm_name) ON DELETE CASCADE,
